...
public class MazeManager : MonoBehaviour
{
    ...
    public GameObject m_MazeHand;
    public GameObject m_MazeHand_2;
    ...
    public IEnumerator MazeDeath()
    {
        m_Player.transform.position = m_MazeStartPos.transform.position;
        //m_Player.gameObject.SetActive(false);
        Vector3 Pos = m_MazeStartPos.transform.position;
        GameObject DieHand = Instantiate(m_MazeHand, m_MazeStartPos.transform.forward +
            new Vector3(Pos.x, Pos.y + 0.5f, Pos.z - 1f), this.transform.rotation);
    ...
    public IEnumerator MazeDeath_2()
    {
        m_Player.Death();
        Vector3 Pos = m_Player.transform.position;
        GameObject DieHand_2 = Instantiate(m_MazeHand_2, m_Player.transform.forward +
            new Vector3(Pos.x, Pos.y, Pos.z - 1), this.transform.rotation);
