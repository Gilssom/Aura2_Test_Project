    ...
    void NearInfo()
    {
        ...
        else if (m_Npc.m_NearNpc && !AllGameManager.Instance.isTalkAction && !AllGameManager.Instance.isWeaponShop)
        {
            if(m_Npc.m_NearNpc.name == "Station Master")
                m_NearNameText.text = "ø™ø¯ ¡÷¿Œ∞˙ ¥Î»≠«œ±‚" + "<color=#FFE400>" + " (E)" + "</color>";
            else if (m_Npc.m_NearNpc.name == "WeaponNpc")
                m_NearNameText.text = "¥Î¿Â¿Â¿ÃøÕ ¥Î»≠«œ±‚" + "<color=#FFE400>" + " (E)" + "</color>";
            else if(m_Npc.m_NearNpc.name == "ArmorNpc")
                m_NearNameText.text = "¿Á∫¿ªÁøÕ ¥Î»≠«œ±‚" + "<color=#FFE400>" + " (E)" + "</color>";
            else if (m_Npc.m_NearNpc.name == "Gate Keeper")
                m_NearNameText.text = "πÆ¡ˆ±‚øÕ ¥Î»≠«œ±‚" + "<color=#FFE400>" + " (E)" + "</color>";
        }
        else
